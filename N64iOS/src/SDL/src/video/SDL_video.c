...
SDL_AddVideoDisplay(const SDL_VideoDisplay * display)
{
    ...
    displays =
        (SDL_VideoDisplay *)SDL_realloc(_this->displays,
...
SDL_AddRenderDriver(SDL_VideoDisplay * display, const SDL_RenderDriver * driver)
{
    ...
    render_drivers = (SDL_RenderDriver *)
...
SDL_GL_ExtensionSupported(const char *extension)
{
    ...
    glGetStringFunc = (const GLubyte *(*)(GLenum))SDL_GL_GetProcAddress("glGetString");
    if (glGetStringFunc) {
...
SDL_GL_GetAttribute(SDL_GLattr attr, int *value)
{
    ...
    glGetIntegervFunc = (void (*)(GLenum, GLint *))SDL_GL_GetProcAddress("glGetIntegerv");
    if (!glGetIntegervFunc) {
        return -1;
    }

    glGetErrorFunc = (GLenum (*)())SDL_GL_GetProcAddress("glGetError");
    if (!glGetErrorFunc) {
        return -1;
    }
