...
#import "../../../../../N64iOS/N64iOS/N64AppDelegate.h"
...
int UIKit_CreateWindow(_THIS, SDL_Window *window) {
	...
	*/
	if (SetupWindowData(_this, window, [UIApplication sharedApplication].delegate.window, SDL_TRUE) < 0) {
        //[uiwindow release];
        return -1;
    }	
	...
	((N64AppDelegate *)[UIApplication sharedApplication].delegate).windowID = window->id;
...
void UIKit_DestroyWindow(_THIS, SDL_Window * window) {
	...
	((N64AppDelegate *)[UIApplication sharedApplication].delegate).windowID = 0;
