...
static void
SDL_AudioThreadInit_Default(SDL_AudioDevice *_this)
{                               /* no-op. */
}

static void
SDL_AudioWaitDevice_Default(SDL_AudioDevice *_this)
{                               /* no-op. */
}

static void
SDL_AudioPlayDevice_Default(SDL_AudioDevice *_this)
{                               /* no-op. */
}

static Uint8 *
SDL_AudioGetDeviceBuf_Default(SDL_AudioDevice *_this)
{
    return NULL;
}

static void
SDL_AudioWaitDone_Default(SDL_AudioDevice *_this)
{                               /* no-op. */
}

static void
SDL_AudioCloseDevice_Default(SDL_AudioDevice *_this)
{                               /* no-op. */
}
...
static int
SDL_AudioOpenDevice_Default(SDL_AudioDevice *_this, const char *devname, int iscapture)
{
    return 0;
}
                  ...
                  int allowed_changes, int min_id)
{
    ...
    device->fake_stream = (unsigned char *)SDL_AllocAudioMem(device->spec.size);
    if (device->fake_stream == NULL) {
        close_audio_device(device);
        SDL_OutOfMemory();
        return 0;
